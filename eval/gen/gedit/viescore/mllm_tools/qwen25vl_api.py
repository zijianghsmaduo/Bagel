...
class Qwen25VLAPI():
    def __init__(self, api_key_path='keys/secret.env', are_images_encoded=False, base_url="https://cloud.infini-ai.com/maas/v1"):
        """Qwen 2.5 VL model wrapper
        Args:
...
if __name__ == "__main__":
    # model = Qwen25VLAPI('/share/liujun/xinhaolee/workspace/mllms/Bagel/qwen_key.txt')
    model = Qwen25VLAPI('abababab', are_images_encoded=True)
    ...
    prompt = model.prepare_prompt(['/share/liujun/xinhaolee/workspace/mllms/Bagel/zbra_edit.png', '/share/liujun/xinhaolee/workspace/mllms/Bagel/zbra.png'], 'What is difference between two images?')
    print("prompt : \n", prompt)
