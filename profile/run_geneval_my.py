...
def generate_image(prompt, num_timesteps=50, cfg_scale=10.0, cfg_interval=[0, 1.0], cfg_renorm_min=0., timestep_shift=1.0, num_images=4, resolution=512, device=None):  # 添加device参数
    ...
    image_token_len = (resolution * resolution) // (model.latent_downsample * model.latent_downsample) + 2
    kv_struct.calculate_gen_image(task_mode="generation", image_token_len=image_token_len)
