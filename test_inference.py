...
def editing_inference(prompt, image, enable_taylorseer = False):
  inference_hyper=dict(
      cfg_text_scale=4.0,
      cfg_img_scale=2.0,
...
def editing_inference_with_thinking(prompt, image, enable_taylorseer = False):
  inference_hyper=dict(
      max_think_token_n=1000,
      do_sample=False,
      # text_temperature=0.3,
  ...
  print(output_dict['text'])
  save_path = "outputs/editing_inference_with_thinking_output.jpg"
  output_dict['image'].save(save_path)
  print(f"Image saved to {save_path}")
